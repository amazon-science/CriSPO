...
"""
Time utilities.
Copied from https://github.com/hankcs/HanLP/blob/master/hanlp/utils/time_util.py
Apache License 2.0
"""
...
from crispo.utilities.log_util import ErasablePrinter, color_format_len
...
class CountdownTimer(ErasablePrinter):
    ...
    def log(
        ...
        interval=0.5,
        erase=True,
        logger: Union[logging.Logger, bool] = None,
        newline=False,
        ratio_width=None,
    ):
        self.update(step)
