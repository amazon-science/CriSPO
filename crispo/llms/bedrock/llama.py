...
class LlamaWrapper(BedrockWrapper):
...
class BedrockLlama(LargeLanguageModel):
    ...
    def generate(self, prompt: TYPE_PROMPT) -> str:
        ...
        try:
            ...
            traceback.print_exc()
            logging.warning("LLAMA max context length error.")
            return ""
