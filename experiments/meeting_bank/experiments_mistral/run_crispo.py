...
train, dev, test = load_meetingbank_shuffled_quick_train_dev_test(trunc=True)


# Trainer
save_dir = "data/experiments/meetingbank_mistral/critique3"
