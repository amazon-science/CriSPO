...
_P = """
For grade school math word problems, a student is expected to solve a question of a grade school math problem following an instruction.
...
class GsmCritiquePrompt(CritiquePrompt):
